...
# Третия версия 
Сравним два механизма выравнивая `alignas` и `aligned_allo` и выберем тот, который показывает лучшиии результаты
...
| Реализация               | Результат (Ticks ?10?) | Прирост (O3 vs O0) |
|--------------------------|-----------------------:|-------------------:|
| **Базовые реализации**   |                        |                    |
| Naive                    | 210.4                 | 2.1x               |
